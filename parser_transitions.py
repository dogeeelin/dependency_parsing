...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        # self.buffer #= sentence, a list of word
        # self.stack #= ["ROOT"]
        # self.dependencies #= []
...
def minibatch_parse(sentences, model, batch_size):
    ...
    @return dependencies (list of dependency lists): A list where each element is the dependencies
                                                    ...
                                                    contain the parse for sentences[i]). parse-句法分析结果
    """
    dependencies = []
    ...
    # inputs: sentences, model, batch_size
    ...
    while unfinished_parses:
        ...
        for p, t in zip(minibatch, predicted_transitions):
            p.parse_step(t)
