...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        @param n_classes (int): number of output classes  3
        ...
        #定义参数：
        # Initialize empty features to hidden weights and hidden bias
        ...
        # Initialize xavier and uniform values for proper scale
        nn.init.xavier_uniform_(self.embed_to_hidden_weight)
        nn.init.uniform_(self.embed_to_hidden_bias)

        # dropout layer with p prob
        self.dropout = nn.Dropout(p=self.dropout_prob)

        # Initialize empty features to hidden weights and b2
